 ...
 <div id="carouselBasicExample" class="carousel slide carousel-fade" data-mdb-ride="carousel">
    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item active">
            <img src="{{ asset('img/supertubosfoto.png') }}" class="d-block w-100" alt="Supertubos" />

            <div class="centered"><img src="{{ asset('img/supertubosgif1.gif') }}" alt=""></div>
        </div>

        <!-- Single item -->
        <div class="carousel-item">
            <img src="{{ asset('img/ericeira.png') }}" class="d-block w-100" alt="Boardriders" />
